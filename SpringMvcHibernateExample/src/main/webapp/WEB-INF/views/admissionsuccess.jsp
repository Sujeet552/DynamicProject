            ...
            <ul class="nav navbar-nav side-nav">
                <li>
                    ...
                    <ul id="submenu-1" class="collapse">
                        ...
                        <li><a href="viewstudents"><i class="fa fa-angle-double-right"></i>View Students</a></li>
                ...
                <li>
                    ...
                    <ul id="submenu-2" class="collapse">
                        <li><a href="studentfeesdetail">Student Fees Report<i class="fa fa-angle-double-right"></i> </a></li>
